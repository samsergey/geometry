...
--getFill, getStroke, getDashing, getLabelText :: Decor a => a -> Maybe String
--find (getThickness :: Decor a => a ->oMaybe Double
--find (getLabelPosition, getLabelOffset :: Decor a => a ->oMaybe CN
--find (getLabelAngle :: Decor a => a ->oMaybe Angular
--find (getSegmentMark, getMultiStroke :: Decor a => a ->oMaybe Int
--find (getLabelCorner :: Decor a => a -> Maybe oInt, Int)
