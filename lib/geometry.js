...
class Figure {
    ...
    scale(a,b) { return this.transform(this.scaleT(a,b||a)); }
    ...
    superpose(p1,p2) { this.shift(line(p1,p2).vector); }
    rotate(a) {	return this.transform(this.rotT(deg2rad(a))); }
    reflect (a) { return this.transform(this.reflectT(deg2rad(a))); }
...
class Point extends Figure {
    ...
    onLine (line,t) { return this.at(line.eqn(t)); }
    onCircle (c,t) { return this.at(c.eqn(t)); }
	...
	return [this.at(s1.intersection(s2)[0].pt)];
    }
	...
	return this.intersection (s1,s2)[0];
    }
