...
class Segment extends Line {
	...
	//tested
	return super.isContaining(point)
	    && this.start.distance(point) >= 0
	    && this.start.distance(point) <= 1;
    }
...
class Polygon extends Curve {
    ...
    closed (bool) { return this.option('closed', bool); }
    ...
    area = {
	//tested
	isContaining : point => this.options.closed
	    && (this.curve.isContaining(point)
...
class Circle extends Curve {
	...
	this.equation = p => equal(p.distance(this.center), this.R);
    }
