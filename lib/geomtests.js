...
('Point',
 [ new test("copy 0", pnt1.copy().label() == pnt1.label())
   ...
   , new test("inside 2", !pnt1.translate([100,100]).isInside)
...
('Line',
 [ new test("identification", lin1 instanceof Curve),
   ...
   , new test("at 1", lin1.through(origin).pivot,[0,0])
   ...
   , new test("intersection 5", new Circle().translate([0,1]).intersections(Ox).map(p => p.xy), [[0,0]])
   , new test("intersection 6", new Circle().translate([0,1.1]).intersections(Ox), [])
 ]);
...
('Polygon',
 [ new test("identification", pol1 instanceof Curve)
   ...
   , new test("area 1", tri1.isInside(tri1.median(3).point(0)))
   , new test("area 2", tri1.isInside(tri1.median(3).middle))
   , new test("area 3", tri1.isInside(tri1.median(3).point(1)))
   , new test("area 4", !tri1.isInside(tri1.median(3).point(2)))
   , new test("area 5", !tri1.isInside(tri1.median(3).point(-1)))
   , new test("area 6", new Square(2).isInside(origin))
   , new test("area 7", new Square(2).isInside(point([1,0])))
   , new test("area 8", !(new Square(2).isInside(point([2,0]))))
...
('Circle',
 [ new test("identification", cir1 instanceof Curve),
   new test("copy 1", seg1.copy().start.xy, seg1.start.xy)
   , new test("copy 2", seg1.copy().end.xy, seg1.end.xy)
   , new test("area 1", cir1.isInside(cir1.center))
   , new test("area 2", cir1.isInside(cir1.center.translate([cir1.R/2,0])))
   , new test("area 3", cir1.isInside(cir1.center.translate([cir1.R-1e-12,0])))
   , new test("area 4", cir1.isInside(cir1.center.translate([cir1.R,0])))
   , new test("area 5", !cir1.isInside(cir1.center.translate([cir1.R+1e-12,0])))
