...
('Angle computations',
 [new property("modulus", [any.angle],
	       a => equal(mod(-a, 360), mod(360-a, 360)))
   , new property("isomorphism 1", [any.xy],
		v => equal(Angle.iso(Angle.iso(v).angle).vector, v.normalize()))
   , new property("isomorphism 2", [any.angle],
		  a => equalMod(360,Angle.iso(Angle.iso(a).vector).angle, a))
 ]);
