...
('Line',
 [ new test("identification", lin1 instanceof Curve),
   ...
   , new test("through 1", lin1.through(pnt2).point(0), pnt2)
...
('Angle',
 [ new testSuite
   ...
   , new test("within 1", new Angle().within(cir1.point(pi/6), cir1.center, cir1.point(pi/3)).value, 30)
   , new test("within 2", new Angle().within(cir1.point(pi/3), cir1.center, cir1.point(pi/6)).value, 330)
   , new test("within 3", new Angle().within(cir1.point(pi/2), cir1.point(2), cir1.point(3*pi/2)).isRight)
   , new test("within 4", new Angle().within(cir1.point(pi/6), cir1.center, cir1.point(pi/6)).value, 0)
...
('Polygon',
 [ new test("identification", pol1 instanceof Curve)
   ...
   , new test("area 1", tri1.area.isContaining(tri1.median(3).point(0)))
   , new test("area 2", tri1.area.isContaining(tri1.median(3).middle))
   , new test("area 3", tri1.area.isContaining(tri1.median(3).point(1)))
   , new test("area 4", !tri1.area.isContaining(tri1.median(3).point(2)))
   , new test("area 5", !tri1.area.isContaining(tri1.median(3).point(-1)))
   ...
   , new test("curve 1", tri1.curve.isContaining(tri1.median(3).point(1)))
   , new test("curve 2", tri1.curve.isContaining(tri1.median(3).point(0)))
   , new test("curve 3", !tri1.curve.isContaining(tri1.bisectrisse(1).point(1/2)))
   , new test("shift")
   , new test("scale")
   , new test("superpose")
   , new test("rotate")
...
('Circle',
 [ new test("identification", cir1 instanceof Curve),
   ...
   , new test("curve 1", cir1.curve.isContaining(cir1.point(1)))
