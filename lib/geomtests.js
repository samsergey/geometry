...
const anyPoint = anyXY.iso(point, p => p.xy)
const anyAngle = anyNum.range(0,360).precision(1)
const anyLine = Arbitrary.tuple([anyPoint, anyPoint])
      .iso(line, l => [l.point(0), l.point(1)])
...
('Points',
 [new Properties([
	 ...
	 require : (p, n) => new Circle(5).at([-7,-7]).isEnclosing(p) },
     {
	 name : "isomorphism 1",
	 for : [any.point],
