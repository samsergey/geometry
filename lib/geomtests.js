...
('Line',
 [ new test("identification", lin1 instanceof Curve),
   ...
   , new test("shift 1", lin1.shift([4,5]).pivot, [5, 7])
	      , new test("shift 2", lin1.shift([4,5]).angle(0), lin1.angle(0))
   ...
   , new test("locate 3", lin1.location(point(lin1.eqn(3).xy.vadd(lin1.norm(0)))), 3)
   , new test("locate 4", lin1.location(point(lin1.eqn(-2).xy.vadd(lin1.norm(0)))), -2)
...
('Angle',
 [ new testSuite
   ...
   , new test("shift 3", ang1.shift([10,20]).start, lin1.angle(0))
