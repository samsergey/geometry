...
var tri1 = triangle(pnt1, pnt2, origin);
...
('Angle',
 [ new testSuite
   ...
   , new test("setValue 1", ang1.setValue(90).starRay.isPerpendicularTo(lin1))
   , new test("setValue 2", new Anglel().setValue(80).start, 0)
