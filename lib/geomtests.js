...
const testLines = {
	...
	},
	{
	    ...
	    with     : (c, x) => [c, x, new Line().at(c.locus(x)).tangentTo(c)],
...
const testCircle = {
	...
	{name: 'radius 1',
	 run : () => new Circle(3).radius(0).end, result : point([3,0])	},
	{name: 'radius 2',
	 run : () => new Circle(3).radius(1/2).end, result : point([-3,0]) },
	{name: 'radius 3',
	 run : () => new Circle(3).radius(1/4).end, result : point([0,3]) },
	{name: 'radius 4',
	 run : () => new Circle(3).radius(1).end, result : point([3,0])	},
