...
function Graphics(viewport, opts)
{
    ...
    this.paper = this.viewport.append('g').attr('class','paper').attr('id','paper')
    ...
    {
	this.viewport.selectAll('.paper').remove();
	this.paper = this.viewport.append('g').attr('class','paper');
	this.viewportWidth = this.viewport.attr('width');
	this.viewportHeight = this.viewport.attr('height');
