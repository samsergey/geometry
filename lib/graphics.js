...
Graphics.prototype.label = function (txt,opts)
{
    ...
    var options = Object.assign(defaults, opts || {})    
    var style = `font-family:${options['font-family']}; font-style:${options['font-style']}; font-size:${options['font-size']}; fill:${options['fill']};`
...
Graphics.prototype.listPlot = function (d, opts)
{
    ...
    var options = Object.assign(defaults, opts || {})
    var style = `stroke-width: ${options['stroke-width']}; stroke: ${options['stroke']};`
    var data = d
	...
	dots.selectAll('circle')
	    ...
	    .attr('style', "fill:red; stroke-width: 1; stroke:#333;")
    }
...
Graphics.prototype.disk = function ([x,y],r,opts)
{
    ...
    var options = Object.assign(defaults, opts || {})    
    var style = `stroke-width: ${options['stroke-width']}; stroke:${options['stroke']}; fill:none;`
    var parent = options.parent && d3.select(options.parent) || this.paper
