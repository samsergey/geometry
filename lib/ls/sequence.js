...
(function(){
  ...
  Gen = (function(){
    ...
    Gen.dropWhile = function*(p, g){
      var x;
      while (!((x = g.next()).done || !p(x.value))) {}
      (yield x.value);
      (yield* g);
    };
    Gen.takeWhile = function*(p, g){
      var x;
      while (!(x = g.next()).done && p(x.value)) {
        if (p(x.value)) {
          (yield x.value);
    ...
    Gen.ascendingBy = function*(f, x0, g){
      var buffer, i$, x;
      buffer = [x0];
      for (i$ = 0; i$ <= 32; ++i$) {
        x = g.next();
  ...
  Sequence = (function(){
    ...
    Sequence.prototype.take = function(n){
      var x$;
      x$ = this;
      x$.setGen(Gen.cons(this.head, Gen.take(n - 1, this.tailGen())));
      return x$;
    };
    ...
    Sequence.prototype.apply = function(f){
      return this.setGen(Gen.apply(f, this.generator()));
    };
    Sequence.prototype.map = function(f){
      return this.setGen(Gen.map(f, this.generator()));
    };
    Sequence.prototype.dropWhile = function(f){
      return this.setGen(Gen.dropWhile(f, this.generator()));
    };
    Sequence.prototype.takeWhile = function(f){
      return this.setGen(Gen.takeWhile(f, this.generator()));
    };
