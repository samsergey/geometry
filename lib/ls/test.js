...
(function(){
  var implies, labeled, anyParam, anyXY, anyPoint, anyAngleValue, anyAngle, anyLine, anySegment, anyRay, anyRadius, anyCircle, anyTriangle, any, testTests, testPoints, testTransformations, testLines, testRays, testSegments, testGroup, testIntersections, testAngles, testCircle, testPolygon, testSquare, allTests;
  ...
  anyAngle = function(){
    return anyAngleValue().iso(function(a){
      return new Angle(a);
    }, function(a){
      return a.value;
    });
    ...
    suite: [
      {
        ...
        'for': [anyAngle()],
        hold: function(a){
          return !a.copy() === a && a.copy().value === a.value;
        }
      }, {
        name: "isContaining",
        suite: [
