...
(function(){
  var M, C, S, G, xxx, Test, Arbitrary, args, ArbitraryNumber, anyNum, anyPos, exports, slice$ = [].slice, arrayFrom$ = Array.from || function(x){return slice$.call(x);};
  M = Monoid;
  C = console;
  S = Sequence;
  G = Gen;
  Test = (function(){
    ...
    var foldJSON, normalize, flatten, runTest, runProperty, checkProperty, reportSuccess, reportFail, prototype = Test.prototype, constructor = Test;
    Test.failed = {
      params: {},
      figures: {},
      tests: {}
    ...
    flatten = function(json){
      ...
      case !(json != null && json.suite):
        return concatMap(flatten, json.suite);
      default:
        return [json];
      }
    };
    ...
    checkProperty = function(options){
      var ac, c, sc, augmentedArgs, proposition, assumption, test, samples, run, runc, res, counts;
      ac = {
        counter: 0
      };
      c = {
      ...
      proposition = count(ac)(function(x){
        return apply(options.hold, apply(augmentedArgs, x));
      });
      assumption = count(ac)(function(x){
